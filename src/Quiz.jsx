...
export default function Quiz() {
    ...
    const handleSelectedChoice = (choiceId) => {
        setSelectedResponse(choiceId);
    };

    const handleNextQuestion = () => {
        if (selectedResponse) {
            if (selectedResponse === currentQuestion.answerId) {
    ...
    return (
        <div>
            ...
            />
            <button onClick={handleNextQuestion} disabled={!selectedResponse}>
                Suivant
            </button>
        </div>
    );
